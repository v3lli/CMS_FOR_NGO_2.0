...
include '../controllas/art.con.php';
 ...
 function render_banner()
 {
    ...
    var_dump($banner);
     echo 
     '<div style="background-image: url('. $banner[0]->spread . ');background-repeat:no-repeat; background-position: center center"      class="d-flex justify-self-center jumbotron-fluid jumbo align-content-center">
